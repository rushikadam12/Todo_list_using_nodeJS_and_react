  ...
  return (
    ...
    <div className='max-w-[100%] min-h-2/3   flex flex-col  bg-[#0A155A] gap-2 justify-center mt-1 rounded-lg'>
      <div className='flex px-2 py-2 min-w-2/3 max-h-1/2'>
        ...
        <p className={`text-2xl w-fit py-1 px-2 text-slate-200 w-full ${Checked ? 'line-through' : null}`}> {task}</p> <button className='px-1 py-1 mt-1 rounded-xl'><AiOutlineDelete color={'white'} size={28}/></button>
